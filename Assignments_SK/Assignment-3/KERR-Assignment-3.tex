...
\NormalTok{text }\OtherTok{\textless{}{-}} \FunctionTok{read\_lines}\NormalTok{(url, }\AttributeTok{skip =} \DecValTok{104}\NormalTok{, }\AttributeTok{n\_max =} \DecValTok{1404}\NormalTok{) }\CommentTok{\# lines 104{-}1508 contain content we want}
