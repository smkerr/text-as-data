...
selected_docs <- mp_availability(countryname %in% countries & partyname %in% parties)
...
if (!file.exists(corpus_path)) {
  ...
  # TODO: codefilter = 401
  corpus <- mp_corpus(selected_docs) # query data 
...
# view beginning of text of first manifesto
kable(head(content(corpus[[1]])))
...
n_topics <- 20 # encode our prior about how many topics are in the document
...
manifesto_topics <- tidy(lda, matrix = "gamma") |>
  left_join(text_tidy, by = c("document" = "text_id"))
